 ...
 *_*Instagram Downloader By WildanXb0t*_*`
          );
...
Artis : *${data.artist}*
   ...
   ----------------------------------
😈                          😈
  _Ytmp3 WhatsApp By WildanXb0t_
`);
chat.sendMessage(media);
});
...
console.log(""+ h);
  ...
  _Ramalan WhatsApp By WildanXb0t_
`
        );
});
 ...
 *_cari sifat berdasarkan nama dan tanggal lahir_* 
 ...
 contoh _!sifat [Chelsea] 31-08-199_ 

🌠 *!sial* tt mm yy
 *_cek hari apes mu_* 

 contoh _!sial 23 12 2005_ 

🌠 *!pasangan* namamu & pasanganmu
 *_Cek kecocokan jodoh_* 

 contoh _!pasangan Anya & Rizky_ 
...
Stay safe ya semuanya , jaga kesehatan nya masing masing , kalo mau mati seterah`
      );
      var imageAsBase64 = fs.readFileSync(
        "./CoronaService/corona.png",
        "base64"
